...
public class TestXFastQueryConcurrencyCorrectness {
    ...
    static ConcurrentXFastTrie trie = new ConcurrentXFastTrie(BITS, THREADS);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("All ConcurrentXFastTrie correctness tests passed.");
    }
    ...
    static void testConcurrentInsert() throws Exception {
        ...
        // Check XFast
        XFastChecker.check(trie);

        System.out.println("concurrent insert: OK (" + bst.size() + " distinct keys, " + THREADS + " threads)");
    }
    ...
    static void assertOps(ConcurrentXFastTrie tree, TreeSet<Long> expected) {
